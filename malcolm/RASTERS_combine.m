...
size_horiz = 250;
numrow = 8;
%numrow = 4; % number of rows in final image

% session names
session_name = {'npJ1_0524_gain_2'};

% where to save images
image_save_dir = 'E:\Dropbox\Work\neuropixels\images\pretty_rasters_whole_session_combined';

%% iterate over sessions
for k = 1:numel(session_name)
    
    image_dir = fullfile('E:\Dropbox\Work\neuropixels\images\',session_name{k},'\pretty_rasters\');
    %image_dir = fullfile('E:\Dropbox\Work\neuropixels\images\',session_name{k},'\pretty_rasters_trial_subset2\');
    %image_dir = fullfile('E:\Dropbox\Work\neuropixels\images\ball_reference_frame\',session_name{k});
    ...
    %imwrite(final_image,fullfile(image_save_dir,sprintf('%s_all_rasters_combined_trial_subset2.png',session_name{k})));
end